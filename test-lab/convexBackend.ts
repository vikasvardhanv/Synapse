...
import type { ConvexProject } from 'synapse-agent/types.js';
import { cleanConvexOutput } from 'synapse-agent/utils/shell.js';
import { execFile } from './utils.js';
import { logger } from 'synapse-agent/utils/logger.js';
