...
import { StreamingMessageParser } from 'synapse-agent/message-parser';
import { withConvexBackend } from './convexBackend';
import { initializeConvexAuth } from 'synapse-agent/convexAuth';
import { deployTool } from 'synapse-agent/tools/deploy';
import { ROLE_SYSTEM_PROMPT } from 'synapse-agent/prompts/system';
import { generateId } from 'ai';
import { ConvexToolSet, SystemPromptOptions } from 'synapse-agent/types';
import { npmInstallTool, npmInstallToolParameters } from 'synapse-agent/tools/npmInstall';
import { lookupDocsTool } from 'synapse-agent/tools/lookupDocs';
import { getConvexDeploymentNameTool } from 'synapse-agent/tools/getConvexDeploymentName';
import { cleanupAssistantMessages } from 'synapse-agent/cleanupAssistantMessages';
import { generalSystemPrompt } from 'synapse-agent/prompts/system';
import { makePartId } from 'synapse-agent/partId';
import { logger } from 'synapse-agent/utils/logger';
import { traced, wrapTraced } from 'braintrust';
import { viewTool } from 'synapse-agent/tools/view';
import { editTool, editToolParameters } from 'synapse-agent/tools/edit';
import { renderFile } from 'synapse-agent/utils/renderFile';
import { renderDirectory } from 'synapse-agent/utils/renderDirectory';
import { viewParameters } from 'synapse-agent/tools/view';
import { lookupDocsParameters, docs, type DocKey } from 'synapse-agent/tools/lookupDocs';
