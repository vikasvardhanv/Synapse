...
import { ROLE_SYSTEM_PROMPT, generalSystemPrompt } from 'synapse-agent/prompts/system';
import { deployTool } from 'synapse-agent/tools/deploy';
import { viewTool } from 'synapse-agent/tools/view';
import type { ConvexToolSet } from 'synapse-agent/types';
import { npmInstallTool } from 'synapse-agent/tools/npmInstall';
import type { Tracer } from '~/lib/.server/chat';
import { editTool } from 'synapse-agent/tools/edit';
import { captureException, captureMessage } from '@sentry/remix';
import type { SystemPromptOptions } from 'synapse-agent/types';
...
import { addEnvironmentVariablesTool } from 'synapse-agent/tools/addEnvironmentVariables';
import { getConvexDeploymentNameTool } from 'synapse-agent/tools/getConvexDeploymentName';
import type { PromptCharacterCounts } from 'synapse-agent/ChatContextManager';
