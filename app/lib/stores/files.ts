...
import { WORK_DIR } from 'synapse-agent/constants.js';
...
import { getAbsolutePath, type AbsolutePath } from 'synapse-agent/utils/workDir';
import type { File, FileMap } from 'synapse-agent/types';
