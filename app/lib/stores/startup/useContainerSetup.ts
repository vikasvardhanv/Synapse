...
import { cleanTerminalOutput } from 'synapse-agent/utils/shell';
...
import { queryEnvVariableWithRetries, setEnvVariablesWithRetries } from 'synapse-agent/convexEnvVariables';
...
async function setupContainer(
  ...
  setSynapseDebugProperty('webcontainer', container);
