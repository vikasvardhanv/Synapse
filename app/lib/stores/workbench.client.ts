...
import type { EditorDocument, ScrollPosition } from 'synapse-agent/types';
import { ActionRunner } from '~/lib/runtime/action-runner';
import type { ActionCallbackData, ArtifactCallbackData } from 'synapse-agent/message-parser';
...
import type { FileMap } from 'synapse-agent/types';
import type { AbsolutePath } from 'synapse-agent/utils/workDir';
import { getAbsolutePath, getRelativePath } from 'synapse-agent/utils/workDir';
...
import { parsePartId, type PartId, type MessageId } from 'synapse-agent/partId.js';
import { generateReadmeContent } from '~/lib/download/readmeContent';
import { setupMjsContent } from '~/lib/download/setupMjsContent';
import type { ConvexProject } from 'synapse-agent/types';
