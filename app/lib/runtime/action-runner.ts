...
import { path as nodePath } from 'synapse-agent/utils/path';
import { atom, map, type MapStore, type WritableAtom } from 'nanostores';
import type { ActionAlert, FileHistory } from '~/types/actions';
import { createScopedLogger } from 'synapse-agent/utils/logger';
import { unreachable } from 'synapse-agent/utils/unreachable';
import type { ActionCallbackData } from 'synapse-agent/message-parser';
...
import { npmInstallToolParameters } from 'synapse-agent/tools/npmInstall';
import { workbenchStore } from '~/lib/stores/workbench.client';
import { z } from 'zod';
import { editToolParameters } from 'synapse-agent/tools/edit';
import { getAbsolutePath } from 'synapse-agent/utils/workDir';
import { cleanConvexOutput } from 'synapse-agent/utils/shell';
import type { BoltAction } from 'synapse-agent/types';
...
import { addEnvironmentVariablesParameters } from 'synapse-agent/tools/addEnvironmentVariables';
