...
export const meta: MetaFunction = () => {
  return [
    { title: 'Synapse by Convex | Generate realtime full‑stack apps' },
    { name: 'description', content: 'Build something amazing with Synapse, the full-stack AI coding agent from Convex' },
    {
      property: 'og:image',
