...
import { ROLE_SYSTEM_PROMPT, generalSystemPrompt } from './synapse-agent/prompts/system.js';
import type { SystemPromptOptions } from './synapse-agent/types.js';
...
writeFileSync('synapse-system-prompts.txt', output);
console.log('✅ Built synapse-system-prompts.txt');
