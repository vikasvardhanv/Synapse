import { setSynapseDebugProperty } from './synapseDebug.js';
...
export function synapseSetLogLevel(level: DebugLevel) {
...
if (typeof window !== 'undefined') {
  ...
  setSynapseDebugProperty('setLogLevel', synapseSetLogLevel);
}
