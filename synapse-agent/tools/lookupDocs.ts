...
import { presenceComponentReadmePrompt } from 'synapse-agent/prompts/components/presence';
import { proseMirrorComponentReadmePrompt } from 'synapse-agent/prompts/components/proseMirror';
import { z } from 'zod';
import { resendComponentReadmePrompt } from 'synapse-agent/prompts/components/resend';
