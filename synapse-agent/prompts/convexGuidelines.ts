...
Convex has but does not support the following components in Synapse: 
DO NOT use the \`lookupDocs\` tool to lookup documentation for these or install them.
Synapse does not have documentation for them. Tell the user that they are unsupported now but will be supported in the future.
- Workflow
- AI Agent
